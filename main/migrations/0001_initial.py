    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdf_preview', models.CharField(blank=True, help_text='S3 key for processed PDF preview', max_length=1024, null=True)),
                ('pages', models.JSONField(blank=True, help_text="List of page/slide dicts: [{'page': 1, 'bucket': ..., 'key': ...}, ...]", null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('avatar', models.ImageField(blank=True, null=True, storage=storages.backends.s3.S3Storage(bucket_name='crops-output-dev', custom_domain='d1fn7ebh3ccl0v.cloudfront.net', file_overwrite=True, location='static', region_name='us-east-2'), upload_to=main.models.workspace_avatar_path)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('board', models.ForeignKey(blank=True, help_text='Board context for sharing. Null = global context, Board = board-specific context.', null=True, on_delete=django.db.models.deletion.CASCADE, to='main.board')),
                ('content_type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='contenttypes.contenttype')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('object_id', models.UUIDField()),
                ('author_email', models.EmailField(blank=True, help_text='Email for anonymous users', max_length=254, null=True)),
                ('author_name', models.CharField(blank=True, help_text='Display name for anonymous users', max_length=255, null=True)),
                ...
                ('page', models.IntegerField(blank=True, help_text='Optional page number for paged assets (PDF, PPT, etc.)', null=True)),
