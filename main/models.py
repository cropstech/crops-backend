...
class FileTransfer(models.Model):
    """Model for tracking file transfers and their metadata"""
    workspace = models.ForeignKey(Workspace, on_delete=models.CASCADE, related_name='file_transfers')
...
class DownloadSession(models.Model):
    """Model for tracking download sessions and progress"""
    file_transfer = models.ForeignKey(FileTransfer, on_delete=models.CASCADE, related_name='download_sessions')
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE)
    ...
    class Meta:
        indexes = [
            ...
            models.Index(fields=['file_transfer', 'status']),
        ]
